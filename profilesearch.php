...
<html>
    ...
    <body>
        ...
        if(isset($_SESSION["loginuser"])){
            $_SESSION["logintype"] = "profile_search";
        }
        else{
        ...
        <input id="profile-search" type="hidden" value="<?php if(isset($_REQUEST["profile_search"])){echo $_REQUEST["profile_search"];}else{echo ""; };
        ?>
        "/>
