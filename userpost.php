...
<html>
    ...
    <body>
        ...
        <input id="notification-id" type="hidden" value="<?php if(isset($_GET["notification_id"])){ echo $_GET["notification_id"];}else{echo "0";}?>"/>
        <input id="post-id" type="hidden" value="<?php if(isset($_GET["post_id"])){ echo $_GET["post_id"];}else{echo "0";}?>"/>
        <div class="container user-post-container">
            <!-- JQUERY CODE -->
        </div>
        <!-- MODAL DIALOG -->
